...
.dropdown:hover .dropbtn {
    ...
    <div class="navbar-header">
        <a href="../staff-list/staff.php" class="navbar-brand">
            <small>
		...
		<div class="dropdown">
		  <button class="dropbtn"><a href="#">Late Coming Details</a></button>
		...
		<div class="dropdown">
		  ...
		  <div class="dropdown-content">
			...
			<a href="../permission.php">Request Permission</a>
			
		  </div>
		</div>
		<div class="dropdown">
		  <button class="dropbtn">Substituion</button>
		  <div class="dropdown-content">
...
<div class="container">
<br/>
<blockquote><h4><a href="">Teacher's Late Coming Detail</a></h4></blockquote>
<br/>
